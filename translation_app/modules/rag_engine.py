...
class RAGEngine:
    def __init__(self, rag_path="rag", collection_name="foreo_translations"):
        ...
        # Assuming run from root (where main.py is), rag folder is at ./rag
        if not os.path.exists(self.rag_path):
            # Try finding it relative to current file (modules/rag_engine.py) -> ../rag
    ...
    def initialize(self):
        ...
        try:
            ...
            # Using cpu explicitly as requested for compatibility
    ...
    def format_rag_prompt(self, query_text, context_pairs, source_lang="English", target_lang="Spanish"):
        ...
        # Construct a prompt piece to be injected/appended
        prompt = f"""
### Style and Context Examples
{context_text}

### Instructions based on examples
